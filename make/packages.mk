...
OPKG_PKGS = luasoap luacurl lua-feedparser ntfs-3g ppp usb-modeswitch openvpn jfsutils xupnpd udpxy mailsend nfs-utils hdparm sdparm iconv
...
iconv: glibc-pkg $(PATCHES)/.rebuild.glibc
	rm -rf $(PKGPREFIX)
	mkdir -p $(PKGPREFIX)
	set -e; cd $(PKGPREFIX); \
