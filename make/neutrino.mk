...
NEUTRINO_DEPS  = libcurl libid3tag libmad freetype libjpeg giflib ffmpeg libdvbsi++ libsigc++ libbluray libass
NEUTRINO_DEPS += openthreads
NEUTRINO_DEPS += lua
NEUTRINO_PKG_DEPS =

N_CFLAGS   = -Wall -W -Wshadow -g -O2 -fno-strict-aliasing -rdynamic -DNEW_LIBCURL -DCPU_FREQ -DMARTII $(LOCAL_NEUTRINO_CFLAGS)
